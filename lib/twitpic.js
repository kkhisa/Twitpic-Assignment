(function() {
  ...
  TwitPic = (function() {
    ...
    TwitPic.thumb = function(image, size, asImg) {
      ...
      if (asImg == null) asImg = true;
      if (typeof image === "object") image = image.short_id;
    ...
    TwitPic.prototype.upload = function(opts, callback) {
      var mimeType;
      if (this.readOnly) throw "/upload requires an API key and OAuth credentials";
